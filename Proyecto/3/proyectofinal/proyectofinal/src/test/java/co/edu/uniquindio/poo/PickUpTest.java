...
public class PickUpTest {
    ...
    public void testCalcularPrecioAlquiler() {
        // Crear una instancia del vehículo con valores iniciales
        PickUpHibrido pickUp = new PickUpHibrido(
            "Toyota", "Nuevo", "2023", "Automático", 180.0, 2.5, TipoCombustible.HIBRIDO, 
            "Automática", 100_000.0, true, true, false, 
            5, 4, true, true, 6, true, true, 1200
        );

        // Calcular el precio esperado manualmente según la lógica
