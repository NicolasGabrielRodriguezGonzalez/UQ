...
public class PickUpHibrido extends VehiculoHibrido {
    ...
    public PickUpHibrido(String marca, String estado, String modelo, String cambios, double velocidadMaxima,
            ...
            boolean aireAcondicionado, boolean camaraReversa, int numBolsasAire, boolean abs, boolean cuatroXCuatro,
    ...
    public void setCamaraRevera(boolean camaraRevera) {
        this.camaraReversa = camaraRevera;
    }
    ...
    public double calcularPrecioAlquiler() {
        ...
        double ajustePorCamaraReversa = (camaraReversa) ? 0.05 : 0.02; // Cámara de reversa tiene un ajuste menor
    ...
    public double calcularPrecioVenta() {
        ...
        double ajustePorCamaraReversa = (camaraReversa) ? 0.10 : 0.05; // Cámara de reversa tiene menor impacto
    ...
    public String toString() {
        return "PickUpHibrido [marca=" + marca + ", numPasajeros=" + numPasajeros + ", estado=" + estado
                ...
                + aireAcondicionado + ", velocidadMaxima=" + velocidadMaxima + ", camaraRevera=" + camaraReversa
